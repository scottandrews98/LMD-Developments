    ...
    <main>
        ...
        <div class="container">
          <form method="post" action="properties.php">
            ...
            <label for="how">Please select an area</label>
              <br/>
        ...
        <section class="index-image2" id="faqSectionCity"></section>
        
        <section class="index-image3" id="faqSectionButton"></section>
        
        <script type="text/javascript">
            document.getElementById("faqSectionButton").onclick = function () {
                location.href = "faq.html";
            };
            
            document.getElementById("faqSectionCity").onclick = function () {
                location.href = "properties.php?cityCentre=City Centre";
            };
