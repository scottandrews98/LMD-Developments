...
<title>LMD Developments - Admin Level 1</title>
</head>
...
<body>
    ...
    <main>
            ...
            <form method="post" action="adminLevel1.php">
        ...
        <div class="container123">
            ...
            <br>
          <form method="POST"	action="adminLevel1.php" enctype="multipart/form-data">
        ...
        <div id="formHeader2">
            ...
            <br>
        <form method="post"	action="adminLevel1.php">
			<label>House Addresses</label>
        	<select name="addressID" class="contactUsInput">
				<?php
                    selectHouses();
                ?>
			</select>
			...
			<label>Bedroom Number</label>
        	<input type="number" name="bedrooms" class="NumberInput"/>
        	<br/>
        
			<label>Price PCM(£)</label>
        	<input type="number" name="price" class="NumberInput"/>
        	<br/>
                
            <label>House Description</label>
        	<input type="text" name="description" class="HouseFormInput" maxlength="800"/>
        	<br/>
			<br/>
		...
		<form method="post"	action="adminLevel1.php">
        	...
        	<input type="text" name="areaName" class="contactUsInput" maxlength="50" required/>
			<br/>
            
            <label>Area Town</label>
            <input type="text" name="areaTown" class="contactUsInput"maxlength="50" required/>
            <br/>
            
            <label>Area County</label>
            <input type="text" name="areaCounty" class="contactUsInput" maxlength="50" required/>
            <br/>
			<br/>
